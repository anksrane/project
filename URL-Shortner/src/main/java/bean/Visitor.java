...
public class Visitor {
	...
	public Visitor(String longUrlVisitor, String shortUrlVisitor, String ipAddress, String visitedDate,
			String visitedTime) {
		super();
	...
	public Visitor(int uid, String longUrlVisitor, String shortUrlVisitor, String ipAddress, String visitedDate,
			String visitedTime) {
		super();
		this.uid = uid;
		this.longUrlVisitor = longUrlVisitor;
