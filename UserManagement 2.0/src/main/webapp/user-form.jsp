			...
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>Full Name</label> <input type="text" id="name"
						value="<c:out value='${user.name}' />" class="form-control" placeholder="First-Name Last-Name"
						name="name" required pattern="[A-Za-z\s]+" title="Only alphabets allowed">
				</fieldset>

				<fieldset class="form-group">
					<label>User Email</label> <input type="email" id="email"
						value="<c:out value='${user.email}' />" class="form-control" placeholder="abc@gmail.com"
						name="email" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$">
				</fieldset>

				<fieldset class="form-group">
					<label>User Password</label> <input type="password" id="password" oncopy="return false" onpaste="return false"
						value="<c:out value='${user.password}' />" class="form-control" placeholder="minimun 8 character"
